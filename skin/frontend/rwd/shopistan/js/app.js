...
$j(document).ready(function () {
	...
	$j('#header-cart').on('click', '.overlay-cart', function(e) {
        var parent = $j(this).parents('.skip-content');
        var link = parent.siblings('.skip-link');
    ...
    enquire.register('(max-width: ' + bp.medium + 'px)', {
        ...
        match: function () {
            this.toggleElements.toggle();
        },
        unmatch: function () {
            this.toggleElements.toggle({destruct: true});
        }
    });
...
var ProductMediaManager = {
    ...
    swapImage: function(targetImage,currentDiv) {
        targetImage = $j(targetImage);
        targetImage.addClass('gallery-image');

        ProductMediaManager.destroyZoom();

        var imageGallery = $j('.'+currentDiv+ ' .product-image-gallery');
    ...
    wireThumbnails: function() {
        ...
        $j('.product-image-thumbs .thumb-link').click(function(e) {
            e.preventDefault();
            var jlink = $j(this);
            var target = $j('.product-img-box-zoom #image-' + jlink.data('image-index'));
            ProductMediaManager.swapImage(target,'product-img-box-zoom');
			
			var jlink = $j(this);
            var target = $j('.product-img-box-normal #image-' + jlink.data('image-index'));
            ProductMediaManager.swapImage(target,'product-img-box-normal');
        });
